    ...
    return () => (
      <div class="bg-[#fff] py-4 px-10 rounded-lg flex">
        ...
        <div class="flex flex-col justify-center items-center">
          ...
          <el-form ref={formRef} model={formData} rules={rules} label-width="50px" status-icon={true}
                   hide-required-asterisk={true} size="large">
            <el-form-item label="账号" prop="username">
              <el-input v-model={formData.username} name="username" type="text" placeholder="用户名/手机号"
                        prefix-icon="UserFilled" />
            </el-form-item>
            <el-form-item label="密码" prop="password">
              <el-input v-model={formData.password} name="password" type="password" placeholder="密码"
                        show-password={true} prefix-icon="Lock" />
            </el-form-item>
            <el-form-item prop="remember" class="remember">
              <el-checkbox v-model={formData.remember} label="记住密码" />
            </el-form-item>
            <el-form-item>
              <el-button size="large" type="primary" class="w-full bg-[#00a8ff]"
                         onClick={_ => submitForm(formRef.value)}>
                登录
              </el-button>
            </el-form-item>
          </el-form>
